...
//                 <div className="flex h-8 w-8 items-center justify-center rounded-full bg-[#EAF3FF] text-[#1677FF]">
//                     <UserRound size={16} />
//                 </div>
//                 <div>
...
//                     </div>
//                     <div>
//                         <p className="text-[10px] font-medium uppercase tracking-wide text-gray-400">Trainer</p>
//                         <p className="text-sm font-semibold text-gray-700">{internship.trainer}</p>
//                     </div>
//                 </div>
//             </div>
//              */}
...
//                     <div>
//                         {/* <p className="text-[10px] font-medium uppercase tracking-wide text-gray-400">Trainer</p> */}
//                         <span className="text-sm font-semibold text-gray-700"  >{internship.company}</span>
//                         <p className="mb-2 flex items-center gap-2 text-sm text-gray-500" >{internship.trainer}</p>
...
//                             <p className="text-sm font-semibold text-gray-700">{internship.seats} seats</p>
//                         </div>
//                     </div>
//                     <div className="flex items-center gap-2">
...
//                             <p className="text-sm font-semibold text-gray-700">{internship.location}</p>
//                         </div>
//                     </div>
//                 </div>
...
//             internship.field === selectedCategory ||
//             internship.internship.toLowerCase().includes(selectedCategory.toLowerCase()) ||
//             internship.company?.toLowerCase().includes(selectedCategory.toLowerCase());
...
//                 const uniqueFields = [...new Set(list.map(item => item.field).filter(Boolean))];
...
//                 setError(err?.message || "Could not load internships right now.");
...
//                     internship.id === opportunityId ? { ...internship, applied: true } : internship,
//                 ),
//             );
//         } catch (err) {
...
//                                 </p>
//                             </div>
//                             {/* <div className="rounded-xl bg-blue-50/50 px-4 py-3 shadow-sm ring-1 ring-blue-100">
//                                 <InfoBox 
//                                 className="text-xs text-gray-400">Available Opportunities 
//                                     <p className="text-xl font-bold text-gray-900">{filteredInternships.length}</p>
//                                 </InfoBox>
...
//                                     <p className="text-xl font-bold text-[#1677FF]">{filteredInternships.length}</p>
...
//                     {error && (
//                         <InfoBox variant="orange" className="mb-4">
//                             {error}
//                         </InfoBox>
//                     )}
...
//                                     Showing{" "}
//                                     <span className="font-semibold text-gray-900">{filteredInternships.length}</span>{" "}
...
//                 const uniqueFields = [...new Set(list.map((item) => item.title).filter(Boolean))];
//                 setCategories(["All Fields", ...uniqueFields]);
...
//             <main className="flex-1 overflow-y-auto scroll-smooth">
//                 <div className="mx-auto w-full max-w-[1240px] px-5 py-5 sm:px-8 sm:py-7">
//                     {/* Header with search – no search input now, but skeleton if needed */}
//                     <header className="mb-6 flex items-center justify-between gap-4">
//                         <div className="relative w-full max-w-[540px]">
//                             {loading ? (
...
//                                     <p className="text-xl font-bold text-[#1677FF]">
//                                         {loading ? "..." : filteredInternships.length}
//                                     </p>
//                                     Available Opportunities
//                                 </InfoBox>
//                             </div>
...
export default function Internships() {
    ...
    // ── Build studentUser from profile ──
    ...
    // Use profile loading or internships loading
    const isLoading = loading || opportunitiesLoading;
