...
const FilterButton = ({ active, children, onClick }) => (
  <button
    type="button"
    onClick={onClick}
    className={`flex h-8 items-center justify-center rounded-full px-4 text-[11px] font-semibold transition duration-200 focus:outline-none focus:ring-2 focus:ring-[#0475FB] focus:ring-offset-1 ${
      active
    ...
    <div className="grid grid-cols-1 gap-3 sm:grid-cols-3 mt-4 print:grid-cols-3 print:gap-4">
      ...
      >
        <div className="flex items-start justify-between">
          ...
          <div
            className="rounded-full p-2 print:hidden"
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <p
              ...
              style={{
                color: isCheckedIn ? "rgba(255,255,255,0.65)" : "#7B8497",
              }}
            >
              Current Internship
            </p>
            ...
            <div
              ...
              style={{
                color: isCheckedIn ? "rgba(255,255,255,0.75)" : "#7B8497",
              }}
            >
        ...
        <div className="flex items-center gap-3 print:hidden">
          <div className="hidden text-right sm:block">
            <p
              ...
              style={{
                color: isCheckedIn ? "rgba(255,255,255,0.6)" : "#7B8497",
              }}
            >
              Today
            </p>
      ...
      <table className="min-w-[800px] w-full border-collapse">
        ...
        <tbody>
          {sessions.map((session, index) => (
            <tr
              key={session.id}
              className={`border-b border-[#E9EDF4] transition hover:bg-[#F9FAFB] print:border-gray-200 print:hover:bg-white ${
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      if (
        ...
        "data" in internshipsData
      ) {
        internshipsData = internshipsData.data;
      }
      const rawInternships = Array.isArray(internshipsData)
        ? internshipsData
        : [];
